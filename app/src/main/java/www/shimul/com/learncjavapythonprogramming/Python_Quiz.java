...
public class Python_Quiz extends AppCompatActivity {
    ...
    public static int lastMark_in_Python;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Python Quiz");
        ...
        submitbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Python_Quiz.this, "Quiz Submitted Correctly", Toast.LENGTH_SHORT).show();
                scoreTextView.setText(Integer.toString(correctAnsScore));
                worngAnsShowText.setText(Integer.toString(correctAns));
                submitbtn.setEnabled(false);

                lastMark_in_Python=correctAnsScore;
